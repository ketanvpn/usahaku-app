...
Rilis berikutnya (siap dipublish): `v1.0.56`

| Versi | Tanggal | Status | Catatan Singkat |
| --- | --- | --- | --- |
| v1.0.56 | 2026-05-02 | Planned | Bundle perbaikan: ringkasan keuangan lintas bulan, optimasi pipeline release, hardening secret policy production, dan template release notes |
